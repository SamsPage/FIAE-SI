Mehr als nur Werbung: **Marketing** ist das Konzept eines Unternehmens, um die **Bedürfnisse** (möglicher) Kunden zu **befriedigen.** Die Aufgabe des Marketings ist also, Veränderungen auf dem Markt zu erkennen und mit entsprechenden Marketingmaßnahmen die Bedürfnisse der Kunden zu erfüllen. Dadurch sollen die **Gewinne** eines Unternehmens erhöht werden.
...
- Methoden: Marktforschung, Wettbewerbsanalyse, Bedarfsanalyse
- Nutzen: Verständnis der Bedürfnisse und Erwartungen der Kunden und des Marktumfelds

**2. Marketingziele festlegen:**
- Ziel: Konkrete Ziele formulieren (z.B. Umsatzsteigerung, Gewinnmaximierung, Markenimage verbessern)
- Nutzen: Zielsetzungen sind die Grundlage für alle folgenden Marketingaktivitäten

**3. Marketingstrategie festlegen:**
- Ziel: Strategische Ausrichtung bestimmen, um die gesetzten Ziele zu erreichen.
- Beispiele: Internationalisierung, Marktdurchdringung, Produktdifferenzierung
...
Die ermittelten Daten und Erkenntnisse liefern eine **Entscheidungshilfe** für z.B. Geschäftsführung, Marketing, Produktmanagement, Einkauf sowie Vertrieb und Controlling.

![Methoden der Marktforschung](/Bilder/Methoden_Marktforschung.png)


Die erhobenen Daten können **primär** (also selbst erhoben, Feldforschung) oder **sekundär** (also bereits vorhanden, Schreibtischforschung) sein.
