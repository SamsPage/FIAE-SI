...
### Stellenbeschreibung
→ Es werden Aufgaben und Kompetenzen des Stelleninhabers, die Anforderungen an den Stelleninhaber sowie die Einordnung der Stelle in die Aufbauorganisation des Betriebes

> [!IMPORTANT]
> Die Stellenbeschreibung ist keine Stellenausschreibung! Es handelt sich um ein internes Dokument, welches auf Anfrage eingesehen werden kann.
...
- Gerechte Beurteilung der Stelleninhaber

**Inhalte:**
- Bezeichnung der Stelle
- Aufgaben, Kompetenzen und Verantwortungsbereich (Welche Tätigkeit umfasst die Stelle?)
